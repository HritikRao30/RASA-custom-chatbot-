...
from excel_data_read import DataStore
...
class FormDataCollect(FormAction):
    ...
    def slot_mappings(self) -> Dict[Text,Union[Dict,List[Dict[Text,Any]]]]:
        return {
            "name":[self.from_text()], #taken simply from the text
            "number":[self.from_entity(entity="number")],  #to take the value from entity
    ...
    def submit(
        ...
        dispatcher.utter_message("Here are the information you provided. Do you want to store it?\nName: {0},\nNumber: {1},\nEmail: {2},\nOccupation: {3}".format(
